        ...
        >
          ...
          >
            ...
            <div className="sticky top-0 z-50 w-full flex items-center justify-between pointer-events-none p-[24px] max-md:p-[14px] max-md:px-[16px] pb-0 max-md:pb-0 -mb-[56px] max-md:-mb-[44px]">
              ...
              <button
                onClick={onClose}
                className="ml-auto pointer-events-auto w-[36px] h-[36px] max-md:w-[32px] max-md:h-[32px] flex items-center justify-center rounded-full bg-white/95 backdrop-blur-md shadow-md border border-[#1A6CFF]/20 text-[#1A6CFF] transition-all hover:bg-[#1A6CFF]/10 hover:scale-110 active:scale-90"
