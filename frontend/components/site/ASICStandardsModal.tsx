...
interface ASICStandardsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onNavigateType?: (type: "privacy" | "msme" | "mca" | "labor") => void;
}

export function ASICStandardsModal({
  isOpen,
  onClose,
  onNavigateType,
}: ASICStandardsModalProps) {
          ...
          >
            ...
            <div className="sticky top-0 z-50 w-full flex justify-end pointer-events-none p-4 sm:p-6 pb-0 -mb-[52px]">
              <button
                ...
                aria-label="Close ASIC Standard document"
              >
                <svg
                  width="18"
                  height="18"
            ...
            {/* Main ASIC Standards Content */}
            <ASICStandardsContent
              onClose={onClose}
