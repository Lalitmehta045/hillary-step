...
export function GlobalStaffingContent({ isModal = false }: { isModal?: boolean }) {
  ...
  return (
    <div className="w-full font-display">
                                ...
                                {activeStep === 4 && (
                                  <div className="flex flex-col gap-[12px]">
                                    ...
                                    <div
                                      ...
                                      className={`flex w-full cursor-pointer flex-col items-center justify-center gap-[12px] rounded-[10px] border-2 border-dashed px-[24px] transition-colors ${isDragging
      ...
      {/* Global Talent Showcase Section */}
