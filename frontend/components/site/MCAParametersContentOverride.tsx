    ...
    section.innerHTML = `
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 items-stretch">
        <div class="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex min-w-0 flex-col gap-3">
          ...
          <div class="grid grid-cols-2 gap-4 pt-2 min-w-0">
            <div class="flex flex-col gap-1">
            ...
            <div class="flex flex-col gap-1">
              <span class="font-display text-[10px] font-[700] tracking-[0.07em] whitespace-nowrap uppercase text-[#9CA3AF]">Date of Incorporation</span>
        ...
        <div class="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex min-w-0 flex-col gap-3">
          ...
          <div class="flex flex-col gap-1">
            ...
            <a href="mailto:info@hillarystepsolutions.com" class="font-display text-[14px] md:text-[14.5px] leading-[1.55] text-[#1A6CFF] hover:underline break-words min-w-0">info@hillarystepsolutions.com</a>
          </div>
