  ...
  useEffect(() => {
    ...
    section.innerHTML = `
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3.5 pt-2">
        <div class="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex flex-col gap-2">
          ...
          <div class="flex flex-col gap-1 pt-1">
            <span class="font-display text-[11px] font-[700] tracking-[0.12em] uppercase text-[#9CA3AF]">Corporate Email</span>
            <a href="mailto:info@hillarystepsolutions.com" class="font-display text-[14px] leading-[1.6] text-[#1A6CFF] hover:underline">info@hillarystepsolutions.com</a>
          </div>
        </div>

        <div class="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex flex-col gap-4">
          <div class="flex flex-col gap-1">
