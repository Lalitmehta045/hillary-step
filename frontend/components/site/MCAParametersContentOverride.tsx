  ...
  useEffect(() => {
    ...
    section.innerHTML = `
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 items-stretch">
        <div class="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex h-auto min-h-[260px] min-w-0 flex-col gap-3 overflow-hidden">
          ...
          <div class="grid grid-cols-[1.25fr_0.75fr] gap-3 pt-2 min-w-0">
            <div class="flex flex-col gap-1">
              <span class="font-display text-[11px] font-[700] tracking-[0.12em] uppercase text-[#9CA3AF]">CIN</span>
              <span class="font-display text-[13.5px] leading-[1.6] tracking-[-0.15px] text-[#4B5563] whitespace-nowrap">U62011UP2020PTC127351</span>
            </div>
            <div class="flex flex-col gap-1">
              <span class="font-display text-[10px] font-[700] tracking-[0.08em] whitespace-nowrap uppercase text-[#9CA3AF]">Date of Incorporation</span>
        ...
        <div class="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex flex-col gap-3 min-h-[260px] overflow-hidden">
          <div class="flex flex-col gap-1">
          ...
          <div class="flex flex-col gap-1">
            ...
            <a href="mailto:info@hillarystepsolutions.com" class="font-display text-[14px] md:text-[14.5px] leading-[1.55] text-[#1A6CFF] hover:underline break-all min-w-0">info@hillarystepsolutions.com</a>
          </div>
