...
export function EcoSmartInfraShowcase() {
  ...
  return (
    <div className="w-full bg-white text-[#111827] font-display antialiased">
      {/* 1. HERO BANNER */}
      <m.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="relative w-full rounded-[20px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.1)]">
      ...
      <section className="relative mt-12 md:mt-20 rounded-[20px] overflow-hidden bg-[#F5F7F2] border border-[#E5E7EB] px-6 py-14 sm:px-10 md:px-14 lg:px-16">
      ...
      <section className="mt-12 md:mt-20 rounded-[20px] overflow-hidden bg-[#111827] text-white px-6 py-14 sm:px-10 md:px-14 lg:px-16">
        <div className="max-w-[1180px] mx-auto">
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-5">
            ...
            <m.div key={selectedLayer.id} initial={{ opacity: 0, x: 18 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.35 }} className="relative min-h-[360px] rounded-[18px] border border-white/10 bg-[#182231] overflow-hidden p-6 sm:p-8 md:p-10">
