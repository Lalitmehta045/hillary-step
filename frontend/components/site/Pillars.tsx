  ...
  return (
    <section className="w-full bg-white pt-[100px] pb-[100px] max-md:py-[60px]">
      <div className="mx-auto w-full max-w-[1280px] px-[64px] max-md:px-[24px]">
        ...
        <div className="mt-[86px] max-md:mt-[48px] grid grid-cols-1 gap-[35px] md:grid-cols-3">
          {PILLARS.map((p) => (
            <article
              key={p.title}
              className="relative h-[721px] max-md:h-[400px] max-lg:h-[500px] overflow-hidden rounded-[32px] border border-[#EFEFF1]"
            >
              <img
                src={p.image}
                alt={p.alt}
