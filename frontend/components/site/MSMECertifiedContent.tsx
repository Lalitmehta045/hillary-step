        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-10 lg:gap-14 pt-6">
          ...
          <main className="flex flex-col gap-10 text-[#374151]">
            ...
            <div className="border-t border-gray-100 pt-8 pb-4 mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex flex-col gap-0.5"><span className="font-display text-[13px] font-[700] tracking-[0.06em] text-[#111827] uppercase">HILLARY STEP SOLUTIONS</span><span className="font-display text-[11px] font-[400] text-[#9CA3AF] tracking-[0.04em] uppercase">© 2024 HILLARY STEP SOLUTIONS. ARCHITECTING ASCENT.</span></div>
