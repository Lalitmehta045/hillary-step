...
import { USLaborCodesContent } from "./USLaborCodesContentOverride";

interface USLaborCodesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onNavigateType?: (type: "privacy" | "msme" | "mca" | "asic") => void;
}

export function USLaborCodesModal({
  isOpen,
  onClose,
  onNavigateType,
}: USLaborCodesModalProps) {
          ...
          >
            <div className="sticky top-0 z-50 w-full flex justify-end pointer-events-none p-4 sm:p-6 pb-0 -mb-[52px]">
              <button
                ...
                aria-label="Close US Corporate Labor Codes document"
              >
