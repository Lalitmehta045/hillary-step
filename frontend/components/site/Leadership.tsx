...
const LEADERS = [
  ...
  },
  {
    ...
    name: "Kanti Singh",
    quote: '"BA/B.Ed graduate serving as foundational Chief Culture Officer in an honorary, non-governing corporate capacity."',
  ...
  },
  {
    ...
    quote: '"Australia-based Electronics & Communication Engineer with twelve years of proven tech expertise driving IT innovation."',
