...
interface MSMECertifiedModalProps {
  isOpen: boolean;
  onClose: () => void;
  onNavigateType?: (type: "mca" | "asic" | "labor" | "privacy") => void;
}

export function MSMECertifiedModal({
  isOpen,
  onClose,
  onNavigateType,
}: MSMECertifiedModalProps) {
          ...
          >
            ...
            <div className="sticky top-0 z-50 w-full flex justify-end pointer-events-none p-4 sm:p-6 pb-0 -mb-[52px]">
              <button
                ...
                aria-label="Close MSME Certified document"
              >
                <svg
                  width="18"
                  height="18"
            ...
            {/* Main MSME Certified Content */}
            <MSMECertifiedContent
              onClose={onClose}
