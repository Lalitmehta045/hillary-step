        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-10 lg:gap-14 pt-6">
          ...
          <main className="flex flex-col gap-10 text-[#374151]">
            ...
            <section id="sec-11" className="scroll-mt-12 flex flex-col gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 pt-1">
                <div className="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex flex-col gap-3">
                  ...
                  <div><span className="block font-display text-[11px] font-[700] tracking-[0.12em] uppercase text-[#9CA3AF]">Email ID</span><a href="mailto:info@hillarystepsolutions.com" className="font-display text-[14px] leading-[1.6] text-[#1A6CFF] hover:underline">info@hillarystepsolutions.com</a></div>
                </div>
                <div className="rounded-[12px] border border-[#E2E8F0]/70 bg-[#F8FAFC] p-4 sm:p-5 flex flex-col gap-3">
            ...
            <div className="border-t border-gray-100 pt-8 pb-4 mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex flex-col gap-0.5"><span className="font-display text-[13px] font-[700] tracking-[0.06em] text-[#111827] uppercase">HILLARY STEP SOLUTIONS PROPRIETARY LIMITED</span><span className="font-display text-[11px] font-[400] text-[#9CA3AF] tracking-[0.04em] uppercase">© 2026 HILLARY STEP SOLUTIONS PROPRIETARY LIMITED. ARCHITECTING ASCENT.</span></div>
