...
import { StatutoryContent, StatutoryType } from "./StatutoryContent";
...
export function StatutoryModal({ type, isOpen, onClose }: StatutoryModalProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Backdrop */}
          <div
            className="absolute inset-0 bg-[#1E3A8A]/30 backdrop-blur-[4px]"
            onClick={onClose}
          />
